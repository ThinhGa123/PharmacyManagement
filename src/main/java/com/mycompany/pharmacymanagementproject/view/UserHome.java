...
public class UserHome extends javax.swing.JFrame {
    ...
    // private MedicinePanel medicinePanel = new MedicinePanel(userDTO);
    private CardLayout cardLayout = new CardLayout();

    public UserHome(UserDTO userDTO) {
        initComponents();
...
//      
//        UpdatePanel.add(medicinePanel, c);
...
//        getContentPane().add(medicinePanel, gbc);
//        gbc.gridy = 1;
//        gbc.weightx = 30;
//        gbc.weighty = 30;
...
//        UpdatePanel.revalidate();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 990, Short.MAX_VALUE)
        );
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addComponent(lableRole, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jpanelCon.setLayout(new java.awt.CardLayout());
...
//        PanelConn.repaint();
//        PanelConn.add(panel);
//        PanelConn.revalidate();
//    }
//    
    private void setInforUser(UserDTO userDTO) {
        lableFullname.setText(userDTO.getFullName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserHome(userDTO).setVisible(true);
            }
        });
    }
